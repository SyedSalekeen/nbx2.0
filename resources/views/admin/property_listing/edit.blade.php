...
"> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="
    width: 30px;
"><path d="M9.36556 10.6821C10.302 12.3288 11.6712 13.698 13.3179 14.6344L14.2024 13.3961C14.4965 12.9845 15.0516 12.8573 15.4956 13.0998C16.9024 13.8683 18.4571 14.3353 20.0789 14.4637C20.599 14.5049 21 14.9389 21 15.4606V19.9234C21 20.4361 20.6122 20.8657 20.1022 20.9181C19.5723 20.9726 19.0377 21 18.5 21C9.93959 21 3 14.0604 3 5.5C3 4.96227 3.02742 4.42771 3.08189 3.89776C3.1343 3.38775 3.56394 3 4.07665 3H8.53942C9.0611 3 9.49513 3.40104 9.5363 3.92109C9.66467 5.54288 10.1317 7.09764 10.9002 8.50444C11.1427 8.9484 11.0155 9.50354 10.6039 9.79757L9.36556 10.6821ZM6.84425 10.0252L8.7442 8.66809C8.20547 7.50514 7.83628 6.27183 7.64727 5H5.00907C5.00303 5.16632 5 5.333 5 5.5C5 12.9558 11.0442 19 18.5 19C18.667 19 18.8337 18.997 19 18.9909V16.3527C17.7282 16.1637 16.4949 15.7945 15.3319 15.2558L13.9748 17.1558C13.4258 16.9425 12.8956 16.6915 12.3874 16.4061L12.3293 16.373C10.3697 15.2587 8.74134 13.6303 7.627 11.6707L7.59394 11.6126C7.30849 11.1044 7.05754 10.5742 6.84425 10.0252Z" fill="black"></path></svg> +1 815-325-2866</a>
                </li>
                </ul>
            </div>
    ...
    <form method="POST" action="{{ route('update_property_listing', $properties->id) }}" enctype="multipart/form-data"
        id="mainForm">
        @csrf
        @method('PUT')
        ...
        <section class="listing-hero-container my">
            ...
            <img id="imagePreview" src="{{ asset('property_managment_listing/' . $properties->cover_image) }}"
                alt="Image Preview">
            <div class="listing-hero-overlay"></div>
            <div class="listing-hero-content">
                <div style="position: absolute;z-index:5;top: 38%;left: 50%;transform: translateX(-50%);color: white;">
...
">
                    ...
                    <input type="file" id="imageInput" name="uploadCover" accept="image/*" multiple style="display:none">


                </div>
                <h1>
                    <input type="text" name="hero_heading" value="{{ $properties->hero_heading }}"
                        class="inputStyle">
        ...
        <section class="">
            <div class="message-bar-container my-shaad">
                <div class="pp-drop-1">
                    <p> <input type="text" name="optional_message_start" class="inputStyle"
                            value="{{ $properties->optional_message_start }}"> </p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-image-container ">
            ...
            <div class="select-box1">
                <label style="margin-top: 10px !important;">Featured ?</label>
                <input type="checkbox" name="featured" value="1" <?php if ($properties->featured == '1') {
                    echo 'checked';
                } ?>>
            </div>
            <!-- upload section -->
            ...
            <div id="appendSections">
                ...
                <?php $a = 0; ?>
                @foreach ($dataCatArray as $keys => $catArray)
                    @if ($catArray == 'asset')
                        <div class="uploading-container" data-cat="asset" style="position:relative">
                            <!-- col-1 -->
                            <div class="file-uploading-bb b1">
                                <div class="tab-button-container">
                                    <label class="my-btn btn1 active" style="color: #fff; background-color: #8d2023; font-family: 'Alphabets'; ">
                                    ...
                                    <label class="my-btn btn2 " for="" style="color: #fff; background-color: #8d2023; font-family: 'Alphabets'; ">
                                    ...
                                    <label class="my-btn btn3 " for="" style="color: #fff; background-color: #8d2023; font-family: 'Alphabets'; ">
                                ...
                                <div class="file-select-1 active" style="height: 208px;">

                                    <div class="" style="display:flex; flex-direction:column; align-items:center; z-index:2">
                                        
                                        <label for="imageInput2{{ $keys }}" style=" display: flex; flex-direction: column;align-items: center;">
                                        <img src="https://rightlinksol.com/portfolios/nbx-capital/public/website/assets/images/icon-1.png" style="width: 75px; margin-right: 9px; ">
                                        <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 15V18H24V20H21V23H19V20H16V18H19V15H21ZM21.0082 3C21.556 3 22 3.44495 22 3.9934L22.0007 13.3417C21.3749 13.1204 20.7015 13 20 13V5H4L4.001 19L13.2929 9.70715C13.6528 9.34604 14.22 9.31823 14.6123 9.62322L14.7065 9.70772L18.2521 13.2586C15.791 14.0069 14 16.2943 14 19C14 19.7015 14.1204 20.3749 14.3417 21.0007L2.9918 21C2.44405 21 2 20.5551 2 20.0066V3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082ZM8 7C9.10457 7 10 7.89543 10 9C10 10.1046 9.10457 11 8 11C6.89543 11 6 10.1046 6 9C6 7.89543 6.89543 7 8 7Z" fill="black"></path></svg>-->
                                        <input type="file" name="images_old[]" id="imageInput2{{ $keys }}"
                                    ...
                                    @if (
                                        @$properties->properties_values[$a]->image_type == 'image' ||
                                            @$properties->properties_values[$a]->image_type == 'link_with_image')
                                        <img id="imagePreview2{{ $keys }}"
                                            src="{{ asset('property_managment_listing/' . @$properties->properties_values[$a]->image) }}"
                                            alt="Image Preview"
                                            style="width: 300px; height: 200px; object-fit: cover; object-position: center top; position: absolute; z-index: 0;">
                                    @else
                                        <img id="imagePreview2{{ $keys }}" src=""
                                            alt="Image Preview"
                                            style="display: none; width: 600px; height: 400px; object-fit: cover; object-position: center top; position: absolute; z-index: 0;">
                                    @endif
                                ...
                                <div class="file-select-2" style="height: 208px;">
                                    <img src="https://rightlinksol.com/portfolios/nbx-capital/public/website/assets/images/icon-2.png" style="width: 75px; margin-right: 9px; ">
                                    <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">-->
                                    <!--    <path-->
                                    ...
                                    <!--</svg>-->
                                    <input style="margin-top: 30px; border-radius: 50px;" class="my-input" type="text" name="links_old[]" value="{{ @$properties->properties_values[$a]->link }}"
                                        placeholder="Your link here...">
                                </div>
                                <div class="file-select-3"  style="height: 208px;">
                                    <label for="actual-btn1" style=" display: flex; flex-direction: column;align-items: center;">
                                        <img src="https://rightlinksol.com/portfolios/nbx-capital/public/website/assets/images/icon-3.png" style="width: 75px; margin-right: 9px; ">
                                    <!--<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 4H15V8H19V20H5V4ZM3.9985 2C3.44749 2 3 2.44405 3 2.9918V21.0082C3 21.5447 3.44476 22 3.9934 22H20.0066C20.5551 22 21 21.5489 21 20.9925L20.9997 7L16 2H3.9985ZM10.4999 7.5C10.4999 9.07749 10.0442 10.9373 9.27493 12.6534C8.50287 14.3757 7.46143 15.8502 6.37524 16.7191L7.55464 18.3321C10.4821 16.3804 13.7233 15.0421 16.8585 15.49L17.3162 13.5513C14.6435 12.6604 12.4999 9.98994 12.4999 7.5H10.4999ZM11.0999 13.4716C11.3673 12.8752 11.6042 12.2563 11.8037 11.6285C12.2753 12.3531 12.8553 13.0182 13.5101 13.5953C12.5283 13.7711 11.5665 14.0596 10.6352 14.4276C10.7999 14.1143 10.9551 13.7948 11.0999 13.4716Z" fill="black"></path></svg>-->
                                    <!--<p>Upload PDF</p>-->
                                    <input style="visibility: hidden;" type="file" id="actual-btn1" name="pdf_old[]" class="inputFileClass" />
                                    </label>
                                </div>
                            </div>
                            <!-- col 2-->
                            <div class="file-uploading-bb b2">
                                <input class="my-input" type="text" placeholder="Add Headline"
                                    name="headings_old[]" value="{{ @$properties->properties_values[$a]->heading }}">
                                <textarea class="my-input" placeholder="Type Something here" name="descriptions_old[]" id=""
                                    cols="30" rows="10">{{ @$properties->properties_values[$a]->description }}</textarea>
                            </div>
                        </div>
                            ...
                            <section class="bg-image-container ">
                                ...
                                <section>
                                    <div class="form-container new-mdl-style">
                                        ...
                                        <input type="text" placeholder="How did you hear about us?" name=""
                                            id="">
            ...
            <section>
                <div class="btns-container">
                    ...
                    <a href="{{ route('preview_listing_page', $properties->id) }}" style="text-decoration: none;">
                        <button type="button">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path d="M11 11V5H13V11H19V13H13V19H11V13H5V11H11Z" fill="rgba(141,32,35,1)"></path>
                            </svg>
            ...
            <section class="" style="margin-top: 150px;">
                <div class="message-bar-container my-shaad">
                    <div class="pp-drop-1">
                        <p> <input type="text" name="optional_message_end" class="inputStyle"
                                value="{{ $properties->optional_message_end }}"> </p>
                    </div>
                </div>
            </section>
    ...
    <script>
        ...
        // Function to handle file input change
        var dataCatArray = @json($dataCatArray);
        var countCat = dataCatArray.length;

        dataCatArray.forEach(function(value, index) {
            if (value == 'asset') {
                document.getElementById('imageInput2' + index).addEventListener('change', function(event) {
                    const files = event.target.files;
                    ...
                    for (let i = 0; i < files.length; i++) {
                        ...
                        reader.onload = function(e) {
                            ...
                            const imgElement = document.getElementById('imagePreview2' + index);
                            imgElement.src = e.target.result;
        ...
        console.log("dataCatArray", dataCatArray);
        document.getElementById('imageInput').addEventListener('change', function(event) {
            const files = event.target.files;
            ...
            <div class="uploading-container">
                ...
                <div class="file-uploading-bb b1">
                    <div class="tab-button-container">
                        ...
                        <label class="my-btn btn2 " for="">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                <path
                                        ...
                                        <svg width="95px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 16H8V8H12C14.2091 8 16 9.79086 16 12C16 14.2091 14.2091 16 12 16ZM10 10V14H12C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10H10ZM15 4H5V20H19V8H15V4ZM3 2.9918C3 2.44405 3.44749 2 3.9985 2H16L20.9997 7L21 20.9925C21 21.5489 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5447 3 21.0082V2.9918Z" fill="black"></path></svg>
                                        PDF
                                    </label>
                                        </div>
                        <div class="file-select-1 active" style=" position: relative; padding: 65px 10px; ">
                         ...
                         <label for="imageInput2${countCat}" style=" display: flex; flex-direction: column;align-items: center;">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21 15V18H24V20H21V23H19V20H16V18H19V15H21ZM21.0082 3C21.556 3 22 3.44495 22 3.9934L22.0007 13.3417C21.3749 13.1204 20.7015 13 20 13V5H4L4.001 19L13.2929 9.70715C13.6528 9.34604 14.22 9.31823 14.6123 9.62322L14.7065 9.70772L18.2521 13.2586C15.791 14.0069 14 16.2943 14 19C14 19.7015 14.1204 20.3749 14.3417 21.0007L2.9918 21C2.44405 21 2 20.5551 2 20.0066V3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082ZM8 7C9.10457 7 10 7.89543 10 9C10 10.1046 9.10457 11 8 11C6.89543 11 6 10.1046 6 9C6 7.89543 6.89543 7 8 7Z" fill="black"></path></svg>
                                        <input type="file" name="images[]" id="imageInput2${countCat}" 
                                            multiple class="inputFileClass" style="width:0";>
                    ...
                    <div class="file-select-2 ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            <path
                                d="M13.0605 8.11073L14.4747 9.52494C17.2084 12.2586 17.2084 16.6908 14.4747 19.4244L14.1211 19.778C11.3875 22.5117 6.95531 22.5117 4.22164 19.778C1.48846 17.0443 1.48846 12.6122 4.22164 9.87849L5.63585 11.2927C3.68323 13.2453 3.68323 16.4112 5.63585 18.3638C7.58847 20.3164 10.7543 20.3164 12.7069 18.3638L13.0605 18.0102C15.0131 16.0576 15.0131 12.8918 13.0605 10.9392L11.6463 9.52494L13.0605 8.11073ZM19.778 14.1211L18.3638 12.7069C20.3164 10.7543 20.3164 7.58847 18.3638 5.63585C16.4112 3.68323 13.2453 3.68323 11.2927 5.63585L10.9392 5.98941C8.98653 7.94203 8.98653 11.1079 10.9392 13.0605L12.3534 14.4747L10.9392 15.8889L9.52494 14.4747C6.79127 11.741 6.79127 7.30886 9.52494 4.57519L9.87849 4.22164C12.6122 1.48797 17.0443 1.48797 19.778 4.22164C22.5117 6.95531 22.5117 11.3875 19.778 14.1211Z"
                                fill="rgba(141,32,35,1)"></path>
                        </svg>
                        <input class="my-input" type="text" name="links[]" placeholder="Your link herer...">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M5 4H15V8H19V20H5V4ZM3.9985 2C3.44749 2 3 2.44405 3 2.9918V21.0082C3 21.5447 3.44476 22 3.9934 22H20.0066C20.5551 22 21 21.5489 21 20.9925L20.9997 7L16 2H3.9985ZM10.4999 7.5C10.4999 9.07749 10.0442 10.9373 9.27493 12.6534C8.50287 14.3757 7.46143 15.8502 6.37524 16.7191L7.55464 18.3321C10.4821 16.3804 13.7233 15.0421 16.8585 15.49L17.3162 13.5513C14.6435 12.6604 12.4999 9.98994 12.4999 7.5H10.4999ZM11.0999 13.4716C11.3673 12.8752 11.6042 12.2563 11.8037 11.6285C12.2753 12.3531 12.8553 13.0182 13.5101 13.5953C12.5283 13.7711 11.5665 14.0596 10.6352 14.4276C10.7999 14.1143 10.9551 13.7948 11.0999 13.4716Z" fill="black"></path></svg>
                                    <p>Upload PDF</p>
                                    <input type="file" id="actual-btn1" name="pdf[]" class="inputFileClass" />
                                    </label>
                                </div>
                    <!-- Add close button -->
