...
@section('content')
    <!-- dashboard -->
    <div class="dashboard">
        <h3 class="text-[#8d2023] text-2xl font-semibold my-3">All Listing </h3>
        <!-- search and filters -->
        <div class="flex flex-wrap"> </div>
        <a href="{{ route('all-services-add') }}"><button
            ...
            <tbody>
                @foreach ($properties as $key => $property)
                    <tr>
                        ...
                        <td><a href="{{ url('all-services/edit/' . $property->id) }}">Edit</a> | <a
                                href="{{ url('all-services/remove/' . $property->id) }}"
